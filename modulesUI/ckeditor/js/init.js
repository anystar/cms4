...
function getConfig (type) {
	var config = {
		filebrowserBrowseUrl : '{{@BASE}}/admin/file_manager/browse_files',
		filebrowserUploadUrl : '{{@BASE}}/admin/file_manager/image_upload_via_dialog',
		...
		removePlugins : 'ckeditor-gwf-plugin',
		skin : ckeditor_skin,
		toolbarGroups : 
		[
